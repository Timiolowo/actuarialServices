...
interface ReservingProps {
  onBack: () => void;
}

export function Reserving({ onBack }: ReservingProps) {
  ...
  return (
    <div className="container" style={{ animation: 'fadeIn 0.4s ease-out' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <div>
          <h1 style={{ fontSize: '2rem', margin: 0 }}>Reserving</h1>
          <p style={{ color: 'var(--text-muted)', margin: '0.25rem 0 0 0' }}>Calculate IBNR and assess total reserve adequacy</p>
        </div>
      </div>
      ...
      {isProcessing ? (
        <div className="glass-panel" style={{ padding: '5rem 2rem', textAlign: 'center', animation: 'fadeIn 0.3s ease-out' }}>
          ...
          <h2 style={{ marginBottom: '0.5rem', fontSize: '1.5rem' }}>Calculating Reserves...</h2>
          <p style={{ color: 'var(--text-muted)' }}>Evaluating reserve risk margins and discount factors.</p>
        ...
        <div className="glass-panel" style={{ padding: '3rem', textAlign: 'center' }}>
          <h3 style={{ marginBottom: '1rem' }}>Upload Claims & Exposure Data</h3>
          <p style={{ color: 'var(--text-muted)', marginBottom: '2rem', maxWidth: '500px', margin: '0 auto 2rem auto' }}>
            Please upload a CSV or Excel file containing your historical claims and exposure metrics.
          </p>
          ...
          {file ? (
            <div style={{ marginTop: '2rem' }}>
              ...
              >
                {isProcessing ? 'Calculating...' : 'Calculate Reserves'}
              </button>
            </div>
          ) : (
            <div style={{ marginTop: '2rem' }}>
        ...
        <div style={{ animation: 'fadeIn 0.4s ease-out' }}>
          <div className="glass-panel" style={{ padding: '3rem', textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h2 style={{ margin: '0 0 1rem 0', fontSize: '1.75rem' }}>Reserves Calculated</h2>
            <p style={{ color: 'var(--text-muted)', marginBottom: '2rem' }}>IBNR estimates and discounting are complete.</p>
