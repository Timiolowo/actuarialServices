  ...
  return (
    <div className="container" style={{ animation: 'fadeIn 0.4s ease-out' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <div>
          <h1 style={{ fontSize: '2rem', margin: 0 }}>Earned Premium Calculator</h1>
          <p style={{ color: 'var(--text-muted)', margin: '0.25rem 0 0 0' }}>Calculate earned premium from policy data</p>
        </div>
      </div>
      ...
      {isProcessing ? (
        <div className="glass-panel" style={{ padding: '5rem 2rem', textAlign: 'center', animation: 'fadeIn 0.3s ease-out' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>Applying actuarial methodologies to policy data.</p>
        ...
        <div className="glass-panel" style={{ padding: '3rem', textAlign: 'center' }}>
          <h3 style={{ marginBottom: '1rem' }}>Upload Policy Data</h3>
          <p style={{ color: 'var(--text-muted)', marginBottom: '2rem', maxWidth: '500px', margin: '0 auto 2rem auto' }}>
            Please upload a CSV or Excel file containing your policy data (e.g. inception date, expiry date, premium).
          </p>
          ...
          {file ? (
            <div style={{ marginTop: '2rem' }}>
              ...
              >
                {isProcessing ? 'Calculating...' : 'Calculate Earned Premium'}
              </button>
            </div>
          ) : (
            <div style={{ marginTop: '2rem' }}>
        ...
        <div style={{ animation: 'fadeIn 0.4s ease-out' }}>
          <div className="glass-panel" style={{ padding: '2rem', marginBottom: '2rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h2 style={{ margin: 0, fontSize: '1.5rem' }}>Calculation Results</h2>
              ...
              <table className="data-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ textAlign: 'right', color: 'var(--primary)', fontWeight: 'bold' }}>$6,000</td>
                  </tr>
                  <tr>
                    <td>POL-1002</td>
                    <td>2025-03-01</td>
                    <td>2026-02-28</td>
                    <td style={{ textAlign: 'right' }}>$24,000</td>
                    <td style={{ textAlign: 'right', color: 'var(--primary)', fontWeight: 'bold' }}>$8,000</td>
                  </tr>
                  <tr>
                    <td>POL-1003</td>
                    <td>2024-07-01</td>
                    <td>2025-06-30</td>
                    <td style={{ textAlign: 'right' }}>$8,500</td>
                    <td style={{ textAlign: 'right', color: 'var(--primary)', fontWeight: 'bold' }}>$8,500</td>
                  </tr>
                </tbody>
              </table>
            </div>
